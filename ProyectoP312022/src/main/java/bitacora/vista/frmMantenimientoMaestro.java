 ...
 * @author visitante
 */
public class frmMantenimientoMaestro extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Codigo Maestro");
        modelo.addColumn("Nombre Maestro");
        modelo.addColumn("Direccion Maestro");
        modelo.addColumn("Telefono Maestro");
        modelo.addColumn("Email Maestro");
        modelo.addColumn("Estatus Maestro");
        daoMaestro vendedorDAO = new daoMaestro();
        List<clsMaestro> vendedores = vendedorDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[6];
        for (int i = 0; i < vendedores.size(); i++) {
            dato[0] = Integer.toString(vendedores.get(i).getmaestrocodigo());
            dato[1] = vendedores.get(i).getmaestronomb();
            dato[2] = vendedores.get(i).getmaestrodirec();
            dato[3] = String.valueOf(vendedores.get(i).getmaetrotelefono());
            dato[4] = vendedores.get(i).getmaestroemail();
            dato[5] = vendedores.get(i).getmaestroestatus();
    ...
    public frmMantenimientoMaestro() {
        initComponents();
        llenadoDeTablas();
        llenadoDeCombos();
    }
    ...
    private void initComponents() {
        ...
        label5.setText("Estatus maestro");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoMaestro vendedorDAO = new daoMaestro();
        clsMaestro vendedorAEliminar = new clsMaestro();
        vendedorAEliminar.setmaestrocodigo(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoMaestro vendedorDAO = new daoMaestro();
        clsMaestro vendedorAInsertar = new clsMaestro();
        vendedorAInsertar.setmaestronomb(txtNombre.getText());
         vendedorAInsertar.setmaestroestatus(txtEstado.getText());
        vendedorAInsertar.setmaetrotelefono(txtTelefono.getText());
        vendedorAInsertar.setmaestrodirec(txtDireccion.getText());
        vendedorAInsertar.setmaestroemail(txtEmail.getText());
